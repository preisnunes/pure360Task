...
class CreateIpCountryTable extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $createSql = "CREATE TABLE IF NOT EXISTS `$this->tableName` (
                  ...
                  `longitude_id`   INT(1) UNSIGNED ZEROFILL NOT NULL, -- the start of maxmind longitude id 
                  `latitude_id`     INT(1) UNSIGNED ZEROFILL NOT NULL, -- the end of maxmind latitude id
